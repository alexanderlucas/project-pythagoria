...
class CationViewController: LevelViewController {
    ...
    @IBOutlet weak var targetTwentyFour: TargetView!
    ...
    override func viewDidLoad() {
        ...
        targets.append(targetTwentyFour)
        targets.append(targetTwentyFive)
        print("hello")
        
        map = CationLevel.init(level: currLevel, arrayOfTargets: targets)
    ...
    func reset() {
        ...
        map = CationLevel.init(level: currLevel, arrayOfTargets: targets)//map
